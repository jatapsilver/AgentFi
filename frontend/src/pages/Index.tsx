...
const Index = () => {
  ...
  const content = {
    en: {
      ...
      description: "Learn DeFi, chat with an intelligent agent, and execute on-chain actions — all in one place.",
      cta: "Get Started",
    ...
    es: {
      ...
      description: "Aprende DeFi, chatea con un agente inteligente y ejecuta acciones on-chain, todo en un solo lugar.",
      cta: "Comenzar",
        ...
        <div className="w-full max-w-2xl mx-auto">
          ...
          <div className="glass-intense rounded-3xl p-8 sm:p-12 shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10 text-center space-y-6 sm:space-y-8">
              ...
              {/* Subtitle */}
              <p className="text-xl sm:text-2xl font-medium text-foreground/90 animate-fade-in" style={{ animationDelay: "0.1s" }}>
                {t.subtitle}
              </p>
